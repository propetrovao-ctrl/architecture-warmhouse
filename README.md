...
Управление устройствами - приложение на Go, которое управляет датчиками температуры в доме
Сервис погоды - Внешний сервис, который дает информацию о температуре на улице
Датчики в доме - Физические устройства: датчики температуры, освещения, движения
